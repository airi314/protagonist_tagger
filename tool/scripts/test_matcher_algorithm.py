...
def main(titles_path, characters_lists_dir_path, testing_sets_dir_path, generated_data_dir,
...
if __name__ == "__main__":
    ...
    parser.add_argument('testing_sets_dir_path', type=dir_path)
    ...
    main(opt.titles_path, opt.characters_lists_dir_path, opt.testing_sets_dir_path,
