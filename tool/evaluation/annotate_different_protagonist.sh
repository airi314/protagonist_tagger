...
python -m tool.scripts.annotate_protagonist data/novels_titles/combined_set.txt data/lists_of_characters data/testing_sets/test/ experiments/"$1"/stanza/ stanza "${@:2}"
